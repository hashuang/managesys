...
def create_update_by_uid_sqlVO(dictVO):
	...
	select_uid_sql = 'UPDATE '+dictVO['table_name']+' SET ' +record['own_col'] +'=%s'+' WHERE '+ record['own_uid']+'='+dictVO['own_id']
	sqlVO={'sql':select_uid_sql,'vars':[dictVO['value'][0][record['own_col'].upper()]]}
	return sqlVO
